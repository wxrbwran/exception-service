...
/**
* @author wuxiaoran
* @description 针对表【t_source_map(sourceMap表)】的数据库操作Service实现
* @createDate 2022-04-13 11:40:17
*/
@Service
public class SourceMapServiceImpl extends ServiceImpl<SourceMapMapper, SourceMap>
    implements SourceMapService{
